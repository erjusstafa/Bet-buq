...
function CasinoAllGames({
  ...
  let Svg = () => (
    <svg class="casino-play-btn" viewBox="0 0 1012 812">
      <path
        id="Color Fill 5"
        fill-rule="evenodd"
        class="shp0"
          ...
          {categoriesFive === "Popular" && (
            <div className={"category-item-games " + categoriesFive}>
              <span style={{ padding: "0 20px" }}>
                ...
                <div id="link" onClick={() => changeId(10) || window.scrollTo({
          ...
          {categoriesZero === "Tournaments" && (
            <div className="category-item-games">
              <span>
                ...
                <div id="link" onClick={() => changeId(14) || window.scrollTo({
                  top: 0, behavior: "smooth",
                })}>
                  All Games <i className="fas fa-angle-right" />
                </div>
                    ...
                    .map((S) => (
                      <Fragment key={S.id}>
                        {Object.values(JSON.parse(S.categories || "{}"))
                          ...
                          .map((N) => (
                            <div className="images-name" style={{ margin: "0 5px" }}>
          ...
          {categoriesOne === "Hot Games" && (
            <div className="category-item-games">
              <span>
                ...
                <div id="link" onClick={() => changeId(7) || window.scrollTo({
                  top: 0, behavior: "smooth",
                })}>
                  All Games <i className="fas fa-angle-right" />
                </div>
          ...
          {categoriesTwo === "New Entry" && (
            <div className="category-item-games" >
              <span>
                ...
                <div id="link" onClick={() => changeId(2) || window.scrollTo({
                  top: 0, behavior: "smooth",
                })}>
                  All Games <i className="fas fa-angle-right" />
                </div>
          ...
          {categoriesThree === "Megaways" && (
            <div className="category-item-games" >
              <span>
                ...
                <div id="link" onClick={() => changeId(8) || window.scrollTo({
                  top: 0, behavior: "smooth",
                })}>
                  All Games <i className="fas fa-angle-right" />
                </div>
          ...
          {categoriesFour === "Instant Games" && (
            <div className="category-item-games" >
              <span>
                ...
                <div id="link" onClick={() => changeId(9) || window.scrollTo({
                  top: 0, behavior: "smooth",
                })}>
                  All Games <i className="fas fa-angle-right" />
                </div>
          ...
          {categoriesSix === "Virtual Games" && (
            <div className="category-item-games">
              <span>
                ...
                <div id="link" onClick={() => changeId(11)}>
                  All Games <i className="fas fa-angle-right" />
                </div>
              </span>
              <div className="all-images-text">
          ...
          {categoriesSeven === "All Slots" && (
            <div className="category-item-games" >
              <span>
                ...
                <div id="link" onClick={() => changeId(1) || window.scrollTo({
                  top: 0, behavior: "smooth",
                })}>
                  All Games <i className="fas fa-angle-right" />
                </div>
